...
import AddChildBanner from "../../../components/parents/AddChildBanner";
import useGetUserProfile from "../../../hooks/tanstack/queryHooks/useGetUserProfile";
import CompleteProfileBanner from "../../../components/parents/CompleteProfileBannder";
...
const SuggestedStoriesSection: React.FC = () => {
  const nav = useNavigation<ParntHomeNavigatorProp>();
  const storiesQuery = useGetRecommendedStories();
